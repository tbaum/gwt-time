...
//    }
    ...
    public MutablePeriod(ReadablePeriod period){
    	this(period,period.getPeriodType(),(Chronology)null);
    }
    
    public MutablePeriod(ReadablePeriod period, PeriodType type){
    ...
    public MutablePeriod(ReadableDuration duration,PeriodType type) {
    	this(duration, type,null);
    }

    public MutablePeriod(ReadableDuration duration,Chronology chrono) {
    ...
    public MutablePeriod(ReadableInterval interval) {
		super(interval, null,(Chronology)null);
	}
    
    public MutablePeriod(ReadableInterval interval, PeriodType type) {
		super(interval, type,null);
	}
    
    public MutablePeriod(ReadableInterval interval,Chronology chrono) {
		super(interval, null, chrono);
	}
	...
	public MutablePeriod(ReadablePeriod period, Chronology chrono) {
		super(period, chrono);
	}
    ...
    public MutablePeriod copy() {
        return new MutablePeriod(this.getYears(),this.getMonths(),
                this.getWeeks(),this.getDays(),this.getHours(),this.getMinutes(),this.getSeconds(),this.getMillis());
    }
