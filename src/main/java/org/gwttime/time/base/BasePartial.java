...
//    }
    ...
    protected BasePartial(ReadablePartial partial, Chronology chrono){
    	super();
    	if(chrono==null)
    	...
    	iValues = Partials.getPartialValues(partial, this, chrono);
    }
    
    protected BasePartial(ReadableInstant instant, Chronology chrono){
    	super();
    	if(chrono==null)
    		iChronology = DateTimeUtils.getChronology(instant.getChronology());
    	else
    		iChronology = DateTimeUtils.getChronology(chrono);
    	iValues = Instants.getPartialValues(this, instant, chrono);
    }
    
    protected BasePartial(Date date, Chronology chrono){
    	super();
    	chrono = DateTimeUtils.getChronology(chrono);
    	iChronology = chrono.withUTC();
    	iValues = Dates.getPartialValues(this, date, chrono);
    }
...
//    }
    ...
    public int[] getValues() {
        return ArrayCopier.copyOf(iValues,iValues.length);
    }
...
//        return DateTimeFormat.forPattern(pattern).print(this);
    ...
    public String toString(String pattern, LocaleInfo locale) throws IllegalArgumentException {
    	...
    	return Formatters.stringForPattern(this, pattern);
//        if (pattern == null) {
//            return toString();
//        }
