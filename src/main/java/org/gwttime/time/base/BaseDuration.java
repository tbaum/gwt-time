...
//    }
    ...
    protected BaseDuration(ReadableDuration duration){
    	super();
    	iMillis = duration.getMillis();
    }
    
    protected BaseDuration(ReadableInterval interval){
    	super();
    	iMillis = interval.toDurationMillis();
    }
