...
//    }
    ...
    protected BaseInterval(ReadableInterval interval,Chronology chrono){
    	super();
    	iChronology = (chrono!=null?chrono: interval.getChronology());
    	iStartMillis = interval.getStartMillis();
    	iEndMillis = interval.getEndMillis();
    	setInto(interval,chrono);
    }
    protected abstract void setInto(ReadableInterval interval, Chronology chrono);
    //-----------------------------------------------------------------------
    /**
