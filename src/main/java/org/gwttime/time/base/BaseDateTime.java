...
public abstract class BaseDateTime
    ...
    //----------------------------------------------------------------------
    public BaseDateTime(ReadableInstant instant){
    	this(instant,ISOChronology.getInstance());
    }
    
    public BaseDateTime(ReadableInstant instant, Chronology chronology){
    	super();
    	iChronology = checkChronology(chronology);
    ...
    public BaseDateTime(Date date,Chronology chronology){
    	super();
    	iChronology = checkChronology(chronology);
    	iMillis = checkInstant(date.getTime(),iChronology);
    }
    
    public BaseDateTime(Date date, DateTimeZone timeZone){
    	this(date, ISOChronology.getInstance(timeZone));
    }
