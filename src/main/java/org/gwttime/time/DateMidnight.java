...
import org.gwttime.time.base.BaseDateTime;
...
//    }
    ...
    public DateMidnight(Date date, Chronology chronology) {
		super(date, chronology);
	}

	public DateMidnight(Date date) {
		super(date);		
	}
	...
	public DateMidnight(int year, int monthOfYear, int dayOfMonth,
		...
		super(year, monthOfYear, dayOfMonth, hourOfDay, minuteOfHour, secondOfMinute,
	...
	public DateMidnight(ReadableInstant instant, Chronology chronology) {
		super(instant, chronology);
	}

	public DateMidnight(ReadableInstant instant) {
		super(instant);
	}

	public DateMidnight(Date date, DateTimeZone timeZone) {
		super(date, timeZone);
	}
     ...
     * should use the {@link org.gwttime.time.MutableDateTime MutableDateTime} class.
     * <p>
    ...
    public static final class Property extends AbstractReadableInstantFieldProperty {
         ...
         */
        public DateMidnight setCopy(String text, LocaleInfo locale) {
