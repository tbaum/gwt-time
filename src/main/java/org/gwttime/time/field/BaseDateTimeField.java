...
public abstract class BaseDateTimeField extends DateTimeField {
     ...
     */
    public String getAsText(long instant, LocaleInfo locale) {
     ...
     * Get the human-readable, text value of this field from the milliseconds.
     * <p>
     * The default implementation calls {@link #getAsText(long, LocaleInfo)}.
     *
     * @param instant  the milliseconds from 1970-01-01T00:00:00Z to query
     * @return the text value of the field
     */
     ...
     * @return the text value of the field
     */
    public String getAsText(ReadablePartial partial, int fieldValue, LocaleInfo locale) {
     ...
     * and {@link #getAsText(ReadablePartial, int, LocaleInfo)}.
     *
     * @param partial  the partial instant to query
     * @param locale  the locale to use for selecting a text symbol, null for default
     * @return the text value of the field
     */
    public String getAsText(ReadablePartial partial, LocaleInfo locale) {
     ...
     * @return the text value of the field
     */
    public String getAsShortText(long instant, LocaleInfo locale) {
     ...
     * Get the human-readable, short text value of this field from the milliseconds.
     * <p>
     * The default implementation calls {@link #getAsShortText(long, LocaleInfo)}.
     *
     * @param instant  the milliseconds from 1970-01-01T00:00:00Z to query
     * @return the text value of the field
     */
     ...
     * @return the text value of the field
     */
    public String getAsShortText(ReadablePartial partial, int fieldValue, LocaleInfo locale) {
     ...
     * @return the text value of the field
     */
    public final String getAsShortText(ReadablePartial partial, LocaleInfo locale) {
     ...
     * Sets a value in the milliseconds supplied from a human-readable, text value.
     * <p>
     * This implementation uses {@link #set(long, String, LocaleInfo)}.
     * <p>
     ...
     * @throws IllegalArgumentException if the text value is invalid
     */
    public int[] set(ReadablePartial instant, int fieldIndex, int[] values, String text, LocaleInfo locale) {
        int value = convertText(text, locale);
