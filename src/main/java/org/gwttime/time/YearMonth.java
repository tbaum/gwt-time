...
//    }
    ...
    public YearMonth(Date date, Chronology chrono) {
		super(date, chrono);
	}

    public YearMonth(ReadableInstant instant){
    	this(instant,null);
    }
    
	public YearMonth(ReadableInstant instant, Chronology chrono) {
		super(instant, chrono);
	}
	
	public YearMonth(ReadablePartial partial){
		this(partial,null);
	}

	public YearMonth(ReadablePartial partial, Chronology chrono) {
    ...
    public DateTimeFieldType[] getFieldTypes() {
        DateTimeFieldType[] fields = new DateTimeFieldType[FIELD_TYPES.length];
        ArrayCopier.copy(FIELD_TYPES,fields);
        return fields;
//        return (DateTimeFieldType[]) FIELD_TYPES.clone();
    ...
    public static class Property extends AbstractPartialFieldProperty implements Serializable {
         ...
         */
        public YearMonth setCopy(String text, LocaleInfo locale) {
            int[] newValues = iYearMonth.getValues();
