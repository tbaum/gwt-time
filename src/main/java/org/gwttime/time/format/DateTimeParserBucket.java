...
public class DateTimeParserBucket {
     ...
     */
    public DateTimeParserBucket(long instantLocal, Chronology chrono, LocaleInfo locale) {
     ...
     * @since 1.1
     */
    public DateTimeParserBucket(long instantLocal, Chronology chrono, LocaleInfo locale, Integer pivotYear) {
        super();
        chrono = DateTimeUtils.getChronology(chrono);
        iMillis = instantLocal;
        iChrono = chrono.withUTC();
        iLocale = (locale == null ? LocaleInfo.getCurrentLocale() : locale);
     ...
     * @param locale  the locale to use
     */
    public void saveField(DateTimeFieldType fieldType, String text, LocaleInfo locale) {
    ...
    public long computeMillis(boolean resetFields, String text) {
        ...
        if (iSavedFieldsShared) {
        	SavedField[] fields = new SavedField[iSavedFields.length];
        	ArrayCopier.copy(iSavedFields,fields);
        	iSavedFields = fields;
        	iSavedFieldsShared = false;
        }
    ...
    static class SavedField implements Comparable<SavedField> {
        ...
        SavedField(DateTimeField field, String text, LocaleInfo locale) {
            iField = field;
            iValue = 0;
            iText = text;
            iLocale = locale;
