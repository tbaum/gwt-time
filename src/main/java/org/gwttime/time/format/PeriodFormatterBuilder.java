...
public class PeriodFormatterBuilder {
    ...
    public PeriodFormatter toFormatter() {
        ...
        FieldFormatter[] formatters = new FieldFormatter[iFieldFormatters.length];
        ArrayCopier.copy(iFieldFormatters, formatters);
        iFieldFormatters = formatters;
    ...
    static class FieldFormatter
        ...
        public int countFieldsToPrint(ReadablePeriod period, int stopAt, LocaleInfo locale) {
            if (stopAt <= 0) {
                return 0;
            }
        ...
        public int calculatePrintedLength(ReadablePeriod period, LocaleInfo locale) {
        ...
        public void printTo(StringBuffer buf, ReadablePeriod period, LocaleInfo locale) {
            long valueLong = getFieldValue(period);
            if (valueLong == Long.MAX_VALUE) {
                return;
            }
        ...
        public int parseInto(
                ...
                int position, LocaleInfo locale) {
