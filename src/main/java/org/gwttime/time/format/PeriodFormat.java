...
public class PeriodFormat {
    ...
    public static PeriodFormatter getDefault() {
        ...
        if (cEnglishWords == null) {
            ...
            pfb = pfb.appendYears();
            pfb = pfb.appendSuffix(" year"," years");           
            pfb = pfb.appendSeparator(", ", " and ", variants);           
            pfb = pfb.appendMonths();
            
            pfb = pfb.appendSeparator(", ", " and ", variants);
            
            pfb = pfb.appendWeeks();
            pfb = pfb.appendSuffix(" week", " weeks");
            pfb = pfb.appendSeparator(", ", " and ", variants);
            pfb = pfb.appendDays();
            pfb = pfb.appendSuffix(" day", " days");
            pfb = pfb.appendSeparator(", ", " and ", variants);
            pfb = pfb.appendMinutes();
            pfb = pfb.appendSuffix(" minute", " minutes");
            pfb = pfb.appendSeparator(", ", " and ", variants);
            pfb = pfb.appendSeconds();
            pfb = pfb.appendSuffix(" second", " seconds");
            pfb = pfb.appendSeparator(", ", " and ", variants);
            pfb = pfb.appendMillis();
            pfb = pfb.appendSuffix(" millisecond", " milliseconds");
            
            cEnglishWords = pfb.toFormatter();
