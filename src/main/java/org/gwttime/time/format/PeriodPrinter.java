...
public interface PeriodPrinter {
     ...
     */
    int calculatePrintedLength(ReadablePeriod period, LocaleInfo locale);
     ...
     */
    int countFieldsToPrint(ReadablePeriod period, int stopAt, LocaleInfo locale);
     ...
     * @param locale  the locale to use
     */
    void printTo(StringBuffer buf, ReadablePeriod period, LocaleInfo locale);
...
//     * @param locale  the locale to use
//     */
//    void printTo(Writer out, ReadablePeriod period, GwtLocale locale) throws IOException;
