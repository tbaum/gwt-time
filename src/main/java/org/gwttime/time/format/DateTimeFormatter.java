 ...
 * <ul>
 * <li>{@link #withLocale(LocaleInfo)} - returns a new formatter that uses the specified locale</li>
...
public class DateTimeFormatter {
    ...
    private DateTimeFormatter(
            DateTimePrinter printer, DateTimeParser parser,
            LocaleInfo locale, boolean offsetParsed,
     ...
     */
    public DateTimeFormatter withLocale(LocaleInfo locale) {
