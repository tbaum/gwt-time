...
public class DateTimeFormat {
     ...
     * {@link DateTimeFormatter#withLocale(LocaleInfo)} and the Short/Medium/Long/Full
        ...
        String getPattern(LocaleInfo locale) {
            ...
            switch (iType) {
                case DATE:
                    ...
                    break;
                case TIME:
                	dtf = com.google.gwt.i18n.client.DateTimeFormat.getFullTimeFormat();
                    break;
                case DATETIME:
                	dtf = com.google.gwt.i18n.client.DateTimeFormat.getFullDateTimeFormat();
                    break;
            }
            return dtf.getPattern();
        }
    }
