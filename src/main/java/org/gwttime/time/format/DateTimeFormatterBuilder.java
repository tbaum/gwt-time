...
public class DateTimeFormatterBuilder {
    ...
    static class CharacterLiteral
        ...
        public void printTo(StringBuffer buf, ReadablePartial partial, LocaleInfo locale) {
            buf.append(iValue);
        }
    ...
    static class TextField
        ...
        private static Map<LocaleInfo, Map<DateTimeFieldType, Object[]>> cParseCache =
                    new HashMap<LocaleInfo, Map<DateTimeFieldType, Object[]>>();
        ...
        private String print(long instant, Chronology chrono, LocaleInfo locale) {
            DateTimeField field = iFieldType.getField(chrono);
            if (iShort) {
        ...
        private String print(ReadablePartial partial, LocaleInfo locale) {
            if (partial.isSupported(iFieldType)) {
        ...
        public int parseInto(DateTimeParserBucket bucket, String text, int position) {
            LocaleInfo locale = bucket.getLocale();
            ...
            synchronized (cParseCache) {
                ...
                if (array == null) {
                    ...
                    for (int i = min; i <= max; i++) {
                        ...
                        //TODO -sf- use locale-specific lower/upper cases here
                    ...
                    if (locale.getLocaleName().contains("en") && iFieldType == DateTimeFieldType.era()) {
    ...
    static class Fraction
        ...
        private void printTo(StringBuffer buf, long instant,
				Chronology chrono) {
        	if(buf==null)return;
        	DateTimeField field = iFieldType.getField(chrono);
        	...
        	try{
        		...
        		//TODO -sf- figure out what Throwable might be thrown here
    ...
    static class TimeZoneName
        ...
        private String print(long instant, DateTimeZone displayZone, LocaleInfo locale) {
            if (displayZone == null) {
                return "";  // no zone
            }
            switch (iType) {
