...
public final class LocalDate
     ...
     */
    public static LocalDate fromFields(int year, int month, int dayOfMonth){
...
//    }
    ...
    public LocalDate(ReadablePartial partial){
    	this(partial,partial.getChronology());
    }
    
    public LocalDate(ReadablePartial partial, DateTimeZone zone){
    	this(partial,ISOChronology.getInstance(zone));
    }
    
    public LocalDate(ReadablePartial partial, Chronology chrono){
    ...
    public LocalDate(Date date){
    	this(date, ISOChronology.getInstance());
    }
    public LocalDate(Date date, DateTimeZone zone){
    	this(date,ISOChronology.getInstance(zone));
    }
    
    public LocalDate(Date date, Chronology chrono){
    	chrono = DateTimeUtils.getChronology(chrono);
...
//    }
	...
	public Date toDate() {
        ...
        if (check.isBefore(this)) {
            ...
            if(dtz.isStandardOffset(this.getLocalMillis())){
                Date earlier = new Date(date.getTime()-3600000);
                check = LocalDate.fromDateFields(earlier);
    ...
    public String toString() {
        return ISODateTimeFormat.date().print(this.toDate().getTime());
    }
...
//            return toString();
//        }
//        return DateTimeFormat.forPattern(pattern).print(this.toDate().getTime());
    }
    ...
    public String toString(String pattern, LocaleInfo locale) throws IllegalArgumentException {
        ...
        return DateTimeFormat.forPattern(pattern).withLocale(locale).print(this.toDate().getTime());
    }
    ...
    public static final class Property extends AbstractReadableInstantFieldProperty {
         ...
         */
        public LocalDate setCopy(String text, LocaleInfo locale) {
