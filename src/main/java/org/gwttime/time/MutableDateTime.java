...
public class MutableDateTime
    ...
    private transient DateTimeField iRoundingField;
...
//    }
	...
	public MutableDateTime(Date date, DateTimeZone timeZone) {
		super(date, timeZone);
	}
    ...
    public MutableDateTime copy() {
        return new MutableDateTime(this.getYear(),this.getMonthOfYear(),this.getDayOfMonth(),
                this.getHourOfDay(),this.getMinuteOfHour(),this.getSecondOfMinute(),this.getMillisOfSecond());
    }
