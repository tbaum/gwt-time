...
import org.gwttime.time.base.BasePeriod;
...
//    }
    ...
    public Period(ReadableDuration duration){
    	this(duration,null,(Chronology)null);
    }
    public Period(ReadableDuration duration,PeriodType type){
    	this(duration,type,null);
    }
    
    public Period(ReadableInterval interval,PeriodType type){
    	this(interval,type,null);
    }
    
    public Period(ReadableDuration duration, Chronology chrono){
    	this(duration,null,chrono);
    }
    
    public Period(ReadableInterval interval,Chronology chrono){
    	this(interval,null,chrono);
    }
    
    public Period(ReadableDuration duration, PeriodType type, Chronology chrono){
    	super(duration,type,chrono);
    }
    
    public Period(ReadableInterval interval, PeriodType type, Chronology chrono){
    	super(interval,type,chrono);
    }
    
    public Period(ReadablePeriod period,Chronology chrono){
    	this(period,null,chrono);
    }
    
    public Period(ReadablePeriod period){
    	this(period,null,null);
    }
    
    public Period(ReadablePeriod period, PeriodType type){
    	this(period,type,null);
    }
    
    public Period(ReadablePeriod period,PeriodType type,Chronology chrono){
    	super(period,type,chrono);
    }
    
    public Period(Period period){
    	this(period,period.getPeriodType());
//    	this(period,period.getPeriodType(),null);
    }
    
    public Period(Period period,PeriodType type){
    	this(period,type!=null?type:period.getPeriodType(),null);
    }
    
    public Period(Period period,Chronology chrono){
    	this(period,period.getPeriodType(),chrono);
    }
    
    public Period(Period period,PeriodType type, Chronology chrono){
    	this(period.toMutablePeriod(),type,chrono);
    }
...
//    }
//    
//    public Period(Duration duration, PeriodType type){
//    	this(duration,type,null);
//    }
//    
//    public Period(Duration duration,Chronology chrono){
//    	this(duration,null,chrono);
//    }
//    
//    public Period(Duration duration, PeriodType type, Chronology chrono){
//    	this(duration.toPeriod(),type,chrono);
//    }
