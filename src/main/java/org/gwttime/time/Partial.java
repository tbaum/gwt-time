...
import org.gwttime.time.base.AbstractPartial;
import org.gwttime.time.field.AbstractPartialFieldProperty;
...
public final class Partial
    ...
    public Partial(DateTimeFieldType[] types, int[] values, Chronology chronology) {
        ...
        org.gwttime.time.util.ArrayCopier.copy(types, iTypes);
        chronology.validate(this, values);
        //iValues = (int[]) values.clone();
        iValues = org.gwttime.time.util.ArrayCopier.copyOf(values, values.length);
    }
    ...
    public DateTimeFieldType[] getFieldTypes() {
        ...
        org.gwttime.time.util.ArrayCopier.copy(iTypes, newTypes);
        return newTypes;
    }
    ...
    public int[] getValues() {
        ...
        return org.gwttime.time.util.ArrayCopier.copyOf(iValues, iValues.length);
    }
    ...
    public String toString() {
        ...
        return f1.print(this.toDateTime(null));
    }
...
//            return toString();
//        }
//        return DateTimeFormat.forPattern(pattern).print(this.toDateTime(null));
    }
     ...
     * @see org.gwttime.time.format.DateTimeFormat
     */
    public String toString(String pattern, LocaleInfo locale) {
        if (pattern == null) {
            return toString();
        }
        return DateTimeFormat.forPattern(pattern).withLocale(locale).print(this.toDateTime(null));
    }
    ...
    public static class Property extends AbstractPartialFieldProperty implements Serializable {
         ...
         */
        public Partial setCopy(String text, LocaleInfo locale) {
            int[] newValues = iPartial.getValues();
