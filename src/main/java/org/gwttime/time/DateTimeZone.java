...
public abstract class DateTimeZone implements Serializable {
    ...
    private static transient Provider cProvider;
    /** The instance that is providing time zone names. */
    private static transient NameProvider cNameProvider;
    ...
    private static transient DateTimeFormatter cOffsetFormatter;
     ...
     */
    public String getShortName(long instant, LocaleInfo locale) {
        if (locale == null) {
     ...
     */
    public String getName(long instant, LocaleInfo locale) {
        if (locale == null) {
            locale = LocaleInfo.getCurrentLocale();
        }
        String nameKey = getNameKey(instant);
