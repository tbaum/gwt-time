...
public final class LocalTime
     ...
     */
    public static LocalTime fromFields(int hourOfDay, int minute,int second, int millis){
        return new LocalTime(hourOfDay,minute,second,millis);
    }
...
//    }
    ...
    public LocalTime(Date date){
    	this(date, (Chronology)null);
    }
    
    public LocalTime(Date date, DateTimeZone zone){
    	this(date,ISOChronology.getInstance(zone));
//    	Chronology chron = ISOChronology.getInstance(zone);
//    	iChronology = chron.withUTC();
//    	long instant = date.getTime(); 
//    	int[] values = chron.get(this,instant);
//    	iLocalMillis = iChronology.getDateTimeMillis(0L,values[0],values[1],values[2],values[3]);
    }
    
    public LocalTime(Date date, Chronology chrono){
    ...
    public LocalTime(ReadablePartial partial){
    	this(partial, partial.getChronology());
    }
    
    public LocalTime(ReadablePartial partial, DateTimeZone zone){
    	this(partial, ISOChronology.getInstance(zone));
    }
    
    public LocalTime(ReadablePartial partial, Chronology chrono){
    	if(chrono==null){
    		iChronology = DateTimeUtils.getChronology(partial.getChronology()).withUTC();
    	}else
    		iChronology = chrono.withUTC();
    	
    	int [] values = Partials.getCheckedPartialValues(partial, this, iChronology);
...
//    }
    ...
    public String toString() {
        return ISODateTimeFormat.time().print(this.toDateTimeToday());
    }
...
//            return toString();
//        }
//        return DateTimeFormat.forPattern(pattern).print(this.toDateTimeToday());
    }
    ...
    public String toString(String pattern, LocaleInfo locale) throws IllegalArgumentException {
        ...
        return DateTimeFormat.forPattern(pattern).withLocale(locale).print(this.toDateTimeToday());
    }
    ...
    public static final class Property extends AbstractReadableInstantFieldProperty {
         ...
         */
        public LocalTime setCopy(String text, LocaleInfo locale) {
