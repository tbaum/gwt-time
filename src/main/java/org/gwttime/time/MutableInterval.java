...
import org.gwttime.time.base.BaseInterval;
...
//    }
    ...
    public MutableInterval(ReadableInterval interval, Chronology chrono) {
		super(interval, chrono);
	}
    ...
    public MutableInterval copy() {
        return new MutableInterval(this.getStart(),this.getEnd());
    }

	@Override
	protected void setInto(ReadableInterval interval, Chronology chrono) {
