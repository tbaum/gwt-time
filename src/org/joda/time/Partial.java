...
public final class Partial
    ...
    public Partial(DateTimeFieldType[] types, int[] values, Chronology chronology) {
        ...
        org.joda.time.util.ArrayCopier.copy(types, iTypes);
        chronology.validate(this, values);
        //iValues = (int[]) values.clone();
        iValues = org.joda.time.util.ArrayCopier.copyOf(values, values.length);
    }
    ...
    public DateTimeFieldType[] getFieldTypes() {
        ...
        org.joda.time.util.ArrayCopier.copy(iTypes, newTypes);
        return newTypes;
    }
    ...
    public int[] getValues() {
        ...
        return org.joda.time.util.ArrayCopier.copyOf(iValues, iValues.length);
    }
