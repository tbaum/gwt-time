 ...
 * @since 1.0
 * @deprecated do not use in GWT, since this is build on reflection,
...
//            CalendarConverter.INSTANCE,
     ...
     * @param object  the object to convert
     * @return the converter to use
     * @throws IllegalArgumentException if no suitable converter, or if more
     * than one suitable converter exists.
     */
