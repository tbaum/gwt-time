...
public class TestISOChronology extends JodaGwtTestCase {
    ...
    private final com.google.gwt.i18n.client.DateTimeFormat dtf = DateTimeFormat.getFormat("YYYY-MM-DDTHH:mm:ss.SSS");
    ...
    public void testMaxYear() {
        ...
        String d = maxYear+"-01-01T00:00:00.000";
        Date date = dtf.parse(d);
        assertEquals(start, new DateTime(date, chrono));
        String endStr = maxYear+"-12-31T23:59:59.999";
