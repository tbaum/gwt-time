...
//    private static int OFFSET_GAZA = 7200000;  // +02:00
    ...
    /*
     * This test is no longer necessary, as it is recommended to use
     * com.google.gwt.i18n.client.DateTimeFormat.parse(String) to get
     * a Date object, and then turn that into a DateTime object.
     */
//    public void test_DateTime_parse_Gaza() {
//        try {
//        	com.google.gwt.i18n.client.DateTimeFormat dtf = com.google.gwt.i18n.client.DateTimeFormat.getFormat("YYYY-MM-DDTHH:mm v");
//        	
//        	
//        	TimeZoneConstants constants = GWT.create(TimeZoneConstants.class);
//        	String gaza = constants.asiaGaza();
//        	Date date = dtf.parse("2007-04-01T00:00 "+gaza);
//        	
