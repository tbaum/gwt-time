...
import org.gwttime.time.YearMonth;
 ...
 */
public class TestYearMonth_Basics extends JodaGwtTestCase {
...
//    private static final Chronology BUDDHIST_LONDON = BuddhistChronology.getInstance(LONDON);
    ...
    public void testToString_String_Locale() {
        YearMonth test = new YearMonth(2002, 6);
        assertEquals("\ufffd \ufffd/6", test.toString("EEE d/M", LocaleInfo.getCurrentLocale()));
//        assertEquals("\ufffd \ufffd/6", test.toString("EEE d/M", Locale.FRENCH));
        assertEquals("2002-06", test.toString(null, LocaleInfo.getCurrentLocale()));
