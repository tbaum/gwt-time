...
public class TestOffsetDateTimeField extends JodaGwtTestCase {
    ...
    public void test_getAsText_long_Locale() {
        OffsetDateTimeField field = new MockOffsetDateTimeField();
        assertEquals("32", field.getAsText(1000L * 29, LocaleInfo.getCurrentLocale()));
    ...
    public void test_getAsShortText_long_Locale() {
        OffsetDateTimeField field = new MockOffsetDateTimeField();
        assertEquals("32", field.getAsShortText(1000L * 29, LocaleInfo.getCurrentLocale()));
    ...
    public void test_add_RP_int_intarray_int() {
        ...
        result = field.add(new LocalTime(), 2, values, 32);
        assertEquals(true, Arrays.equals(expected, result));
        
        values = new int[] {10, 20, 30, 40};
        expected = new int[] {10, 21, 3, 40};
        result = field.add(new LocalTime(), 2, values, 33);
        assertEquals(true, Arrays.equals(expected, result));
        
        values = new int[] {23, 59, 30, 40};
        try {
            field.add(new LocalTime(), 2, values, 33);
            fail();
        } catch (IllegalArgumentException ex) {}
    ...
    public void test_addWrapField_RP_int_intarray_int() {
        ...
        result = field.addWrapField(new LocalTime(), 2, values, 33);
        assertEquals(true, Arrays.equals(result, expected));
    }
    ...
    public void test_set_RP_int_intarray_int() {
        ...
        try {
            field.set(new LocalTime(), 2, values, 63);
            fail();
        } catch (IllegalArgumentException ex) {}
        ...
        expected = new int[] {10, 20, 30, 40};
        try {
            field.set(new LocalTime(), 2, values, 2);
            fail();
        } catch (IllegalArgumentException ex) {}
        assertEquals(true, Arrays.equals(values, expected));
    }
    ...
    public void test_set_long_String_Locale() {
        ...
        assertEquals(26050L, field.set(50L, "29", LocaleInfo.getCurrentLocale()));
    }
    ...
    public void test_set_RP_int_intarray_String_Locale() {
        ...
        expected = new int[] {10, 20, 30, 40};
        try {
            field.set(new LocalTime(), 2, values, "63", null);
            fail();
        } catch (IllegalArgumentException ex) {}
        assertEquals(true, Arrays.equals(values, expected));
        ...
        expected = new int[] {10, 20, 30, 40};
        try {
            field.set(new LocalTime(), 2, values, "2", null);
            fail();
        } catch (IllegalArgumentException ex) {}
        assertEquals(true, Arrays.equals(values, expected));
    }
...
//    public abstract DurationField getRangeDurationField();
    ...
    public void test_getMinimumValue_RP() {
        OffsetDateTimeField field = new MockOffsetDateTimeField();
        assertEquals(3, field.getMinimumValue(new LocalTime()));
    }

    public void test_getMinimumValue_RP_intarray() {
        OffsetDateTimeField field = new MockOffsetDateTimeField();
        assertEquals(3, field.getMinimumValue(new LocalTime(), new int[4]));
    }
    ...
    public void test_getMaximumValue_RP() {
        OffsetDateTimeField field = new MockOffsetDateTimeField();
        assertEquals(62, field.getMaximumValue(new LocalTime()));
    }

    public void test_getMaximumValue_RP_intarray() {
        OffsetDateTimeField field = new MockOffsetDateTimeField();
        assertEquals(62, field.getMaximumValue(new LocalTime(), new int[4]));
    }
