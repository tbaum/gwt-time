...
public class TestPreciseDurationDateTimeField extends JodaGwtTestCase {
    ...
    public void test_getAsText_long_Locale() {
        BaseDateTimeField field = new MockPreciseDurationDateTimeField();
        assertEquals("29", field.getAsText(60L * 29, LocaleInfo.getCurrentLocale()));
    ...
    public void test_getAsText_RP_int_Locale() {
        BaseDateTimeField field = new MockPreciseDurationDateTimeField();
        assertEquals("20", field.getAsText(new LocalTime(12, 30, 40, 50), 20, LocaleInfo.getCurrentLocale()));
        assertEquals("20", field.getAsText(new LocalTime(12, 30, 40, 50), 20, null));
    }

    public void test_getAsText_RP_Locale() {
        BaseDateTimeField field = new MockPreciseDurationDateTimeField();
        assertEquals("40", field.getAsText(new LocalTime(12, 30, 40, 50), LocaleInfo.getCurrentLocale()));
        assertEquals("40", field.getAsText(new LocalTime(12, 30, 40, 50), null));
    }

    public void test_getAsText_int_Locale() {
        BaseDateTimeField field = new MockPreciseDurationDateTimeField();
        assertEquals("80", field.getAsText(80, LocaleInfo.getCurrentLocale()));
    ...
    public void test_getAsShortText_long_Locale() {
        BaseDateTimeField field = new MockPreciseDurationDateTimeField();
        assertEquals("29", field.getAsShortText(60L * 29, LocaleInfo.getCurrentLocale()));
    ...
    public void test_getAsShortText_RP_int_Locale() {
        BaseDateTimeField field = new MockPreciseDurationDateTimeField();
        assertEquals("20", field.getAsShortText(new LocalTime(12, 30, 40, 50), 20, LocaleInfo.getCurrentLocale()));
        assertEquals("20", field.getAsShortText(new LocalTime(12, 30, 40, 50), 20, null));
    }

    public void test_getAsShortText_RP_Locale() {
        BaseDateTimeField field = new MockPreciseDurationDateTimeField();
        assertEquals("40", field.getAsShortText(new LocalTime(12, 30, 40, 50), LocaleInfo.getCurrentLocale()));
        assertEquals("40", field.getAsShortText(new LocalTime(12, 30, 40, 50), null));
    }

    public void test_getAsShortText_int_Locale() {
        BaseDateTimeField field = new MockPreciseDurationDateTimeField();
        assertEquals("80", field.getAsShortText(80, LocaleInfo.getCurrentLocale()));
    ...
    public void test_add_RP_int_intarray_int() {
        ...
        int[] result = field.add(new LocalTime(), 2, values, 0);
        assertEquals(true, Arrays.equals(expected, result));
        
        values = new int[] {10, 20, 30, 40};
        expected = new int[] {10, 20, 31, 40};
        result = field.add(new LocalTime(), 2, values, 1);
        assertEquals(true, Arrays.equals(expected, result));
        
        values = new int[] {10, 20, 30, 40};
        expected = new int[] {10, 21, 0, 40};
        result = field.add(new LocalTime(), 2, values, 30);
        assertEquals(true, Arrays.equals(expected, result));
        
        values = new int[] {23, 59, 30, 40};
        try {
            field.add(new LocalTime(), 2, values, 30);
            fail();
        } catch (IllegalArgumentException ex) {}
        ...
        result = field.add(new LocalTime(), 2, values, -31);
        assertEquals(true, Arrays.equals(expected, result));
        
        values = new int[] {0, 0, 30, 40};
        try {
            field.add(new LocalTime(), 2, values, -31);
            fail();
        } catch (IllegalArgumentException ex) {}
    }
    ...
    public void test_addWrapField_RP_int_intarray_int() {
        ...
        int[] values = new int[] {10, 20, 30, 40};
        int[] expected = new int[] {10, 20, 30, 40};
        int[] result = field.addWrapField(new LocalTime(), 2, values, 0);
        assertEquals(true, Arrays.equals(result, expected));
        
        values = new int[] {10, 20, 30, 40};
        expected = new int[] {10, 20, 59, 40};
        result = field.addWrapField(new LocalTime(), 2, values, 29);
        assertEquals(true, Arrays.equals(result, expected));
        
        values = new int[] {10, 20, 30, 40};
        expected = new int[] {10, 20, 0, 40};
        result = field.addWrapField(new LocalTime(), 2, values, 30);
        assertEquals(true, Arrays.equals(result, expected));
        
        values = new int[] {10, 20, 30, 40};
        expected = new int[] {10, 20, 1, 40};
        result = field.addWrapField(new LocalTime(), 2, values, 31);
        assertEquals(true, Arrays.equals(result, expected));
    }
    ...
    public void test_set_RP_int_intarray_int() {
        ...
        int[] values = new int[] {10, 20, 30, 40};
        int[] expected = new int[] {10, 20, 30, 40};
        int[] result = field.set(new LocalTime(), 2, values, 30);
        assertEquals(true, Arrays.equals(result, expected));
        
        values = new int[] {10, 20, 30, 40};
        expected = new int[] {10, 20, 29, 40};
        result = field.set(new LocalTime(), 2, values, 29);
        assertEquals(true, Arrays.equals(result, expected));
        
        values = new int[] {10, 20, 30, 40};
        expected = new int[] {10, 20, 30, 40};
        try {
            field.set(new LocalTime(), 2, values, 60);
            fail();
        } catch (IllegalArgumentException ex) {}
        ...
        expected = new int[] {10, 20, 30, 40};
        try {
            field.set(new LocalTime(), 2, values, -1);
            fail();
        } catch (IllegalArgumentException ex) {}
        assertEquals(true, Arrays.equals(values, expected));
    }
    ...
    public void test_set_long_String_Locale() {
        ...
        assertEquals(29 * 60, field.set(0L, "29", LocaleInfo.getCurrentLocale()));
    }
    ...
    public void test_set_RP_int_intarray_String_Locale() {
        ...
        int[] values = new int[] {10, 20, 30, 40};
        int[] expected = new int[] {10, 20, 30, 40};
        int[] result = field.set(new LocalTime(), 2, values, "30", null);
        assertEquals(true, Arrays.equals(result, expected));
        
        values = new int[] {10, 20, 30, 40};
        expected = new int[] {10, 20, 29, 40};
        result = field.set(new LocalTime(), 2, values, "29", LocaleInfo.getCurrentLocale());
        assertEquals(true, Arrays.equals(result, expected));
        
        values = new int[] {10, 20, 30, 40};
        expected = new int[] {10, 20, 30, 40};
        try {
            field.set(new LocalTime(), 2, values, "60", null);
            fail();
        } catch (IllegalArgumentException ex) {}
        assertEquals(true, Arrays.equals(values, expected));
        ...
        expected = new int[] {10, 20, 30, 40};
        try {
            field.set(new LocalTime(), 2, values, "-1", null);
            fail();
        } catch (IllegalArgumentException ex) {}
        assertEquals(true, Arrays.equals(values, expected));
    }
...
//    public abstract DurationField getRangeDurationField();
    ...
    public void test_getMinimumValue_RP() {
        BaseDateTimeField field = new MockPreciseDurationDateTimeField();
        assertEquals(0, field.getMinimumValue(new LocalTime()));
    }

    public void test_getMinimumValue_RP_intarray() {
        BaseDateTimeField field = new MockPreciseDurationDateTimeField();
        assertEquals(0, field.getMinimumValue(new LocalTime(), new int[4]));
    }
    ...
    public void test_getMaximumValue_RP() {
        BaseDateTimeField field = new MockPreciseDurationDateTimeField();
        assertEquals(59, field.getMaximumValue(new LocalTime()));
    }

    public void test_getMaximumValue_RP_intarray() {
        BaseDateTimeField field = new MockPreciseDurationDateTimeField();
        assertEquals(59, field.getMaximumValue(new LocalTime(), new int[4]));
    }

    //-----------------------------------------------------------------------
    public void test_getMaximumTextLength_Locale() {
        BaseDateTimeField field = new MockPreciseDurationDateTimeField();
        assertEquals(2, field.getMaximumTextLength(LocaleInfo.getCurrentLocale()));
        ...
        assertEquals(1, field.getMaximumTextLength(LocaleInfo.getCurrentLocale()));
        ...
        assertEquals(3, field.getMaximumTextLength(LocaleInfo.getCurrentLocale()));
        ...
        assertEquals(4, field.getMaximumTextLength(LocaleInfo.getCurrentLocale()));
    ...
    public void test_getMaximumShortTextLength_Locale() {
        BaseDateTimeField field = new MockPreciseDurationDateTimeField();
        assertEquals(2, field.getMaximumShortTextLength(LocaleInfo.getCurrentLocale()));
    }
    ...
    static class MockCountingDurationField extends BaseDurationField {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 3377298328017670689L;
    ...
    static class MockZeroDurationField extends BaseDurationField {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 5709825987677469306L;
    ...
    static class MockImpreciseDurationField extends BaseDurationField {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 2678053085871696290L;
