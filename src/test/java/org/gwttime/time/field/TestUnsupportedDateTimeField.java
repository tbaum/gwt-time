...
public class TestUnsupportedDateTimeField extends JodaGwtTestCase {
    ...
    public void testUnsupportedMethods() {
        ...
        // Locale locale)
        try {
            fieldOne.getAsShortText(0, LocaleInfo.getCurrentLocale());
            assertTrue(false);
        } catch (UnsupportedOperationException e) {
            assertTrue(true);
        }
        ...
        try {
            fieldOne.getAsShortText(100000L, LocaleInfo.getCurrentLocale());
            assertTrue(false);
        } catch (UnsupportedOperationException e) {
            assertTrue(true);
        }
        ...
        // Locale locale)
        try {
            fieldOne.getAsShortText(localTime, 0, LocaleInfo.getCurrentLocale());
            assertTrue(false);
        } catch (UnsupportedOperationException e) {
            assertTrue(true);
        }
        ...
        // Locale locale)
        try {
            fieldOne.getAsShortText(localTime, LocaleInfo.getCurrentLocale());
            assertTrue(false);
        } catch (UnsupportedOperationException e) {
            assertTrue(true);
        }
        ...
        // Locale locale)
        try {
            fieldOne.getAsText(0, LocaleInfo.getCurrentLocale());
            assertTrue(false);
        } catch (UnsupportedOperationException e) {
            assertTrue(true);
        }
        ...
        try {
            fieldOne.getAsText(1000L,LocaleInfo.getCurrentLocale());
            assertTrue(false);
        } catch (UnsupportedOperationException e) {
            assertTrue(true);
        }
        ...
        // Locale locale)
        try {
            fieldOne.getAsText(localTime, 0, LocaleInfo.getCurrentLocale());
            assertTrue(false);
        } catch (UnsupportedOperationException e) {
            assertTrue(true);
        }
        ...
        // Locale locale)
        try {
            fieldOne.getAsText(localTime, LocaleInfo.getCurrentLocale());
            assertTrue(false);
        } catch (UnsupportedOperationException e) {
            assertTrue(true);
        }
        ...
        try {
            fieldOne.getMaximumShortTextLength(LocaleInfo.getCurrentLocale());
            assertTrue(false);
        } catch (UnsupportedOperationException e) {
            assertTrue(true);
        }
        ...
        // UnsupportedOperationException
        try {
            fieldOne.getMaximumTextLength(LocaleInfo.getCurrentLocale());
            assertTrue(false);
        } catch (UnsupportedOperationException e) {
            assertTrue(true);
        }
        ...
        try {
            fieldOne
                    .set(1000000L, "Unsupported Operation", LocaleInfo.getCurrentLocale());
            assertTrue(false);
        } catch (UnsupportedOperationException e) {
            assertTrue(true);
        }
        ...
        try {
            fieldOne.set(localTime, 0, new int[] { 0 },
                    "Unsupported Operation", LocaleInfo.getCurrentLocale());
            assertTrue(false);
        } catch (UnsupportedOperationException e) {
            assertTrue(true);
        }
