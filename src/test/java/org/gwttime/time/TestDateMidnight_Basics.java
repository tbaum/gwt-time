...
import org.gwttime.time.base.AbstractInstant;
...
public class TestDateMidnight_Basics extends JodaGwtTestCase {
    ...
    public void testToString() {
        ...
        assertEquals(ConstantsForTesting.TEST_TIME_NOW_MIDNIGHT_LONDON_STRING, test.toString());
        
        test = new DateMidnight(TEST_TIME_NOW_UTC, PARIS);
        assertEquals(ConstantsForTesting.TEST_TIME_NOW_MIDNIGHT_PARIS_STRING, test.toString());
        
        test = new DateMidnight(TEST_TIME_NOW_UTC, NEWYORK);
        assertEquals(ConstantsForTesting.TEST_TIME_NOW_MIDNIGHT_NEWYORK_STRING, test.toString());  // the 8th
    }

    public void testToString_String() {
        DateMidnight test = new DateMidnight(TEST_TIME_NOW_UTC);
        assertEquals("2002 00", test.toString("yyyy HH"));
        assertEquals(ConstantsForTesting.TEST_TIME_NOW_MIDNIGHT_LONDON_STRING, test.toString((String) null));
    }
    ...
    public void testToString_String_String() {
        ...
        assertEquals(ConstantsForTesting.TEST_TIME_NOW_MIDNIGHT_LONDON_STRING, test.toString(null, LocaleInfo.getCurrentLocale()));
        assertEquals("Sun 9/6", test.toString("EEE d/M", null));
        assertEquals(ConstantsForTesting.TEST_TIME_NOW_MIDNIGHT_LONDON_STRING, test.toString(null, null));
    }

    public void testToString_DTFormatter() {
        DateMidnight test = new DateMidnight(TEST_TIME_NOW_UTC);
        assertEquals("2002 00", test.toString(DateTimeFormat.forPattern("yyyy HH")));
        assertEquals(ConstantsForTesting.TEST_TIME_NOW_MIDNIGHT_LONDON_STRING, test.toString((DateTimeFormatter) null));
    }
	...
	public void testWithFields_RPartial() {
        ...
        DateMidnight result = test.withFields(new LocalDate(2003, 4, 5));
    ...
    public void testProperty() {
        ...
        DateTimeFieldType bad = new DateTimeFieldType("bad") {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -1697916436108856498L;
