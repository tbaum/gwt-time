...
import org.gwttime.time.Seconds;
import org.gwttime.time.base.AbstractDuration;
import org.gwttime.time.base.BaseDuration;
...
public class TestDuration_Basics extends JodaGwtTestCase {
    ...
    static class MockMutableDuration extends BaseDuration {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -4164893116338185411L;
