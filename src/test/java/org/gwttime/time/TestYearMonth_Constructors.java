 ...
 */
public class TestYearMonth_Constructors extends JodaGwtTestCase {
	...
	public void testFactory_FromDateFields() throws Exception {
    	Date date = new Date(1970-1900,1,3,4,5,6);
        YearMonth expected = new YearMonth(1970, 2);
        assertEquals(expected, YearMonth.fromDateFields(date));
        try {
