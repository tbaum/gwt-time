...
//        + 28L * DateTimeConstants.MILLIS_PER_MINUTE;
    ...
    public void testToString() {
        ...
        assertEquals("2002-06-09T10:20:30.040+01:00", test.toString());
    }
    ...
    public void testToString_String() {
        ...
        assertEquals("2002-06-09T10:20:30.040+01:00", test.toString((String) null));
    }
...
//        assertEquals("mar. 9/6", test.toString("EEE d/M", Locale.FRENCH));
        assertEquals("1970-06-09T10:20:30.040Z", test.toString(null, LocaleInfo.getCurrentLocale()));
        assertEquals("Tue 9/6", test.toString("EEE d/M", null));
        assertEquals("1970-06-09T10:20:30.040Z", test.toString(null, null));
    }
    ...
    public void testToString_DTFormatter() {
        ...
        assertEquals("2002-06-09T10:20:30.040+01:00", test.toString((DateTimeFormatter) null));
    }
