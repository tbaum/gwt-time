...
//        + 4L;
    ...
    public void testIsSupported_DateTimeFieldType() {
        ...
        DateTimeFieldType d = new DateTimeFieldType("hours") {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -658217293781367039L;
        ...
        d = new DateTimeFieldType("hourOfYear") {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 6942501172519713206L;
			public DurationFieldType getDurationType() {
                return DurationFieldType.hours();
            }
            public DurationFieldType getRangeDurationType() {
	...
	public void testEqualsHashCode() {
        ...
        assertEquals(true, test1.equals(new LocalTime(10, 20, 30, 40, COPTIC_UTC)));
        assertEquals(true, test1.hashCode() == new LocalTime(10, 20, 30, 40, COPTIC_UTC).hashCode());
	...
	public void testCompareTo() {
        ...
        assertEquals(0, test1.compareTo(new LocalTime(10, 20, 30, 40)));
    }
    ...
    public void testToDateTime_RI() {
        ...
        check(base, 10, 20, 30, 40);
        assertEquals("1970-01-01T00:00:00.000Z", dt.toString());
        assertEquals("1970-01-01T10:20:30.040Z", test.toString());
    }
    ...
    public void testToDateTime_nullRI() {
        ...
        check(base, 1, 2, 3, 4);
        assertEquals("1970-01-02T01:02:03.004Z", test.toString());
    }
    ...
    public void testToString() {
        LocalTime test = new LocalTime(10, 20, 30, 40);
        assertEquals("10:20:30.040Z", test.toString());
    }
    ...
    public void testToString_String() {
        ...
        assertEquals("10:20:30.040Z", test.toString((String) null));
    }

    //-----------------------------------------------------------------------
    public void testToString_String_Locale() {
        LocalTime test = new LocalTime(10, 20, 30, 40);
        assertEquals("10 20", test.toString("H m", LocaleInfo.getCurrentLocale()));
        assertEquals("10:20:30.040Z", test.toString(null, LocaleInfo.getCurrentLocale()));
        assertEquals("10 20", test.toString("H m", null));
        assertEquals("10:20:30.040Z", test.toString(null, null));
    }
    ...
    public void testToString_DTFormatter() {
        ...
        assertEquals("10:20:30.040Z", test.toString((DateTimeFormatter) null));
    }
