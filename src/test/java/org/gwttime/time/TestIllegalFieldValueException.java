...
public class TestIllegalFieldValueException extends JodaGwtTestCase {
    ...
    public void testSetText() {
        try {
            ISOChronology.getInstanceUTC().year().set(0, null, LocaleInfo.getCurrentLocale());
            fail();
        } catch (IllegalFieldValueException e) {
            assertEquals(DateTimeFieldType.year(), e.getDateTimeFieldType());
            assertEquals(null, e.getDurationFieldType());
        ...
        try {
            ISOChronology.getInstanceUTC().year().set(0, "nineteen seventy", LocaleInfo.getCurrentLocale());
            fail();
        } catch (IllegalFieldValueException e) {
            assertEquals(DateTimeFieldType.year(), e.getDateTimeFieldType());
            assertEquals(null, e.getDurationFieldType());
        ...
        try {
            ISOChronology.getInstanceUTC().era().set(0, "long ago", LocaleInfo.getCurrentLocale());
            fail();
        } catch (IllegalFieldValueException e) {
        ...
        try {
            ISOChronology.getInstanceUTC().monthOfYear().set(0, "spring", LocaleInfo.getCurrentLocale());
            fail();
        } catch (IllegalFieldValueException e) {
            assertEquals(DateTimeFieldType.monthOfYear(), e.getDateTimeFieldType());
            assertEquals(null, e.getDurationFieldType());
        ...
        try {
            ISOChronology.getInstanceUTC().dayOfWeek().set(0, "yesterday", LocaleInfo.getCurrentLocale());
            fail();
        } catch (IllegalFieldValueException e) {
        ...
        try {
            ISOChronology.getInstanceUTC().halfdayOfDay().set(0, "morning", LocaleInfo.getCurrentLocale());
            fail();
        } catch (IllegalFieldValueException e) {
    ...
    public void testGJCutover() {
    	Date date = Formatters.dateForPattern("1582-10-04", "yyyy-MM-dd");
        ...
        Date nextDate = Formatters.dateForPattern("1582-10-15", "yyyy-MM-dd");
        dt = new DateTime(nextDate, GJChronology.getInstanceUTC());
        try {
	...
	public void testReadablePartialValidate() {
        try {
            ...
            assertEquals("-5", e.getIllegalValueAsString());
            assertEquals(new Integer(1), e.getLowerBound());
            assertEquals(12, e.getUpperBound());
        }

        try {
            new LocalDate(1970, 500, 1);
            fail();
        } catch (IllegalFieldValueException e) {
            assertEquals(DateTimeFieldType.monthOfYear(), e.getDateTimeFieldType());
            assertEquals(null, e.getDurationFieldType());
