...
public class TestPeriod_Constructors extends JodaGwtTestCase {
	...
	public void testConstructor_RP_RP1() throws Throwable {
        ...
        LocalDate dt2 = new LocalDate(2005, 7, 10);
        Period test = new Period(dt1, dt2);
        assertEquals(PeriodType.standard(), test.getPeriodType());
        assertEquals(1, test.getYears());
        assertEquals(1, test.getMonths());
	...
	public void testConstructor_RP_RP3() throws Throwable {
        LocalDate dt1 = null;
        LocalDate dt2 = new LocalDate(2005, 7, 17);
        try {
            new Period(dt1, dt2);
            fail();
        } catch (IllegalArgumentException ex) {}
	...
	public void testConstructor_RP_RP4() throws Throwable {
        LocalDate dt1 = new LocalDate(2005, 7, 17);
        LocalDate dt2 = null;
        try {
            new Period(dt1, dt2);
            fail();
	...
	public void testConstructor_RP_RP6() throws Throwable {
        LocalDate dt1 = new LocalDate(2005, 7, 17);
        LocalTime dt2 = new LocalTime(10, 20, 30, 40);
        try {
            new Period(dt1, dt2);
            fail();
        } catch (IllegalArgumentException ex) {}
...
//    }
	...
	public void testFactoryFieldDifference1() throws Throwable {
        LocalDate start = new LocalDate(2005, 4, 9);
	...
	public void testFactoryFieldDifference2() throws Throwable {
        LocalDate ymd = new LocalDate(2005, 4, 9);
        try {
	...
	public void testFactoryFieldDifference3() throws Throwable {
        LocalDate start = new LocalDate(2005, 4, 9);
        LocalTime endTime = new LocalTime(12, 30, 40, 0);
        try {
