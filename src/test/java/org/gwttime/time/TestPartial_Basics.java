...
//    private static final int OFFSET = 1;
	...
	public void testEqualsHashCode() {
        ...
        assertEquals(new LocalTime(10, 20, 30, 40), createTODPartial(ISO_UTC));
    }
	...
	public void testCompareTo() {
        ...
        assertEquals(0, new LocalTime(10, 20, 30, 40).compareTo(createTODPartial(ISO_UTC)));
    }
    ...
    public void testToDateTime_RI() {
        ...
        check(base, 10, 20);
        assertEquals("1970-01-01T00:00:00.000Z", dt.toString());
        assertEquals("1970-01-01T10:20:00.000Z", test.toString());
    }
    ...
    public void testToDateTime_nullRI() {
        ...
        check(base, 1, 2);
        assertEquals("1970-01-02T01:02:07.008Z", test.toString());
    }
    ...
    public void testToString_String_Locale() {
        ...
        assertEquals("10:20", test.toString(null, LocaleInfo.getCurrentLocale()));
