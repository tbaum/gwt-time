...
public class TestISODateTimeFormat_Fields extends JodaGwtTestCase {
    ...
    public void testForFields_empty() {
        try {
            ISODateTimeFormat.forFields(new ArrayList<DateTimeFieldType>(), true, true);
            fail();
        } catch (IllegalArgumentException ex) {}
    }
    ...
    public void testForFields_calBased_YMD() {
        ...
        List<DateTimeFieldType> types = new ArrayList<DateTimeFieldType>(Arrays.asList(fields));
        ...
        types = new ArrayList<DateTimeFieldType>(Arrays.asList(fields));
    ...
    public void testForFields_calBased_YMD_unmodifiable() {
        ...
        int[] values = new int[] {2005, 6, 25};
        List<DateTimeFieldType> types = Collections.unmodifiableList(new ArrayList<DateTimeFieldType>(Arrays.asList(fields)));
        DateTimeFormatter f = ISODateTimeFormat.forFields(types, true, true);
        assertEquals("2005-06-25", f.print(new Partial(fields, values)));
    ...
    public void testForFields_calBased_YMD_duplicates() {
        ...
        int[] values = new int[] {2005, 6, 25};
        List<DateTimeFieldType> types = new ArrayList<DateTimeFieldType>(Arrays.asList(dupFields));
        DateTimeFormatter f = ISODateTimeFormat.forFields(types, true, true);
        assertEquals("2005-06-25", f.print(new Partial(fields, values)));
        assertEquals(0, types.size());
