...
public class TestDateTimeFormat extends JodaGwtTestCase {
    ...
    protected void gwtSetUp() throws Exception {
        ...
        //Locale.setDefault(LocaleInfo.getCurrentLocale());
    ...
    public void testFormat_era() {
        ...
        DateTimeFormatter f = DateTimeFormat.forPattern("G").withLocale(LocaleInfo.getCurrentLocale());
    ...
    public void testFormat_centuryOfEra() {
        DateTime dt = new DateTime(2004, 6, 9, 10, 20, 30, 40, UTC);
        DateTimeFormatter f = DateTimeFormat.forPattern("C").withLocale(LocaleInfo.getCurrentLocale());
    ...
    public void testFormat_yearOfEra() {
        DateTime dt = new DateTime(2004, 6, 9, 10, 20, 30, 40, UTC);
        DateTimeFormatter f = DateTimeFormat.forPattern("Y").withLocale(LocaleInfo.getCurrentLocale());
    ...
    public void testFormat_yearOfEra_twoDigit() {
        DateTime dt = new DateTime(2004, 6, 9, 10, 20, 30, 40, UTC);
        DateTimeFormatter f = DateTimeFormat.forPattern("YY").withLocale(LocaleInfo.getCurrentLocale());
        ...
        f = DateTimeFormat.forPattern("YY").withLocale(LocaleInfo.getCurrentLocale());
        f = f.withZone(UTC);
        f.parseDateTime("5");
        f.parseDateTime("005");
        f.parseDateTime("+50");
    ...
    public void testFormat_yearOfEraParse() {
        ...
        DateTimeFormatter f = DateTimeFormat
            ...
            .withLocale(LocaleInfo.getCurrentLocale());
    ...
    public void testFormat_weekyear() {
        DateTime dt = new DateTime(2004, 6, 9, 10, 20, 30, 40, UTC);
        DateTimeFormatter f = DateTimeFormat.forPattern("x").withLocale(LocaleInfo.getCurrentLocale());
        assertEquals(dt.toString(), "2004", f.print(dt));
    ...
    public void testFormat_weekyearOfEra_twoDigit() {
        DateTime dt = new DateTime(2004, 6, 9, 10, 20, 30, 40, UTC);
        DateTimeFormatter f = DateTimeFormat.forPattern("xx").withLocale(LocaleInfo.getCurrentLocale());
        assertEquals(dt.toString(), "04", f.print(dt));
        ...
        // Added tests to ensure two digit parsing is lenient for DateTimeFormat
        f = DateTimeFormat.forPattern("xx").withLocale(LocaleInfo.getCurrentLocale());
        f = f.withZone(UTC);
        f.parseDateTime("5");
        f.parseDateTime("005");
        f.parseDateTime("+50");
    ...
    public void testFormat_weekOfWeekyear() {
        DateTime dt = new DateTime(2004, 6, 9, 10, 20, 30, 40, UTC);
        DateTimeFormatter f = DateTimeFormat.forPattern("w").withLocale(LocaleInfo.getCurrentLocale());
    ...
    public void testFormat_dayOfWeek() {
        DateTime dt = new DateTime(2004, 6, 9, 10, 20, 30, 40, UTC);
        DateTimeFormatter f = DateTimeFormat.forPattern("e").withLocale(LocaleInfo.getCurrentLocale());
...
//        assertEquals(dt.toString(), "mer.", f.print(dt));
    ...
    public void testFormat_dayOfWeekText() {
        DateTime dt = new DateTime(2004, 6, 9, 10, 20, 30, 40, UTC);
        DateTimeFormatter f = DateTimeFormat.forPattern("EEEE").withLocale(LocaleInfo.getCurrentLocale());
...
//        assertEquals(dt.toString(), "mercredi", f.print(dt));
    ...
    public void testFormat_dayOfYearText() {
        DateTime dt = new DateTime(2004, 6, 9, 10, 20, 30, 40, UTC);
        DateTimeFormatter f = DateTimeFormat.forPattern("D").withLocale(LocaleInfo.getCurrentLocale());
    ...
    public void testFormat_monthOfYear() {
        DateTime dt = new DateTime(2004, 6, 9, 10, 20, 30, 40, UTC);
        DateTimeFormatter f = DateTimeFormat.forPattern("M").withLocale(LocaleInfo.getCurrentLocale());
    ...
    public void testFormat_monthOfYearShortText() {
        DateTime dt = new DateTime(2004, 6, 9, 10, 20, 30, 40, UTC);
        DateTimeFormatter f = DateTimeFormat.forPattern("MMM").withLocale(LocaleInfo.getCurrentLocale());
...
//        assertEquals(dt.toString(), "juin", f.print(dt));
    ...
    public void testFormat_monthOfYearText() {
        DateTime dt = new DateTime(2004, 6, 9, 10, 20, 30, 40, UTC);
        DateTimeFormatter f = DateTimeFormat.forPattern("MMMM").withLocale(LocaleInfo.getCurrentLocale());
...
//        assertEquals(dt.toString(), "juin", f.print(dt));
    ...
    public void testFormat_halfdayOfDay() {
        DateTime dt = new DateTime(2004, 6, 9, 10, 20, 30, 40, UTC);
        DateTimeFormatter f = DateTimeFormat.forPattern("a").withLocale(LocaleInfo.getCurrentLocale());
    ...
    public void testFormat_hourOfHalfday() {
        DateTime dt = new DateTime(2004, 6, 9, 10, 20, 30, 40, UTC);
        DateTimeFormatter f = DateTimeFormat.forPattern("K").withLocale(LocaleInfo.getCurrentLocale());
    ...
    public void testFormat_clockhourOfHalfday() {
        DateTime dt = new DateTime(2004, 6, 9, 10, 20, 30, 40, UTC);
        DateTimeFormatter f = DateTimeFormat.forPattern("h").withLocale(LocaleInfo.getCurrentLocale());
        assertEquals(dt.toString(), "10", f.print(dt));
    ...
    public void testFormat_second() {
        DateTime dt = new DateTime(2004, 6, 9, 10, 20, 30, 40, UTC);
        DateTimeFormatter f = DateTimeFormat.forPattern("s").withLocale(LocaleInfo.getCurrentLocale());
    ...
    public void testFormat_fractionOfSecond() {
        DateTime dt = new DateTime(2004, 6, 9, 10, 20, 30, 40, UTC);
        DateTimeFormatter f = DateTimeFormat.forPattern("SSS").withLocale(LocaleInfo.getCurrentLocale());
    ...
    public void testFormat_fractionOfSecondLong() {
        DateTime dt = new DateTime(2004, 6, 9, 10, 20, 30, 40, UTC);
        DateTimeFormatter f = DateTimeFormat.forPattern("SSSSSS").withLocale(LocaleInfo.getCurrentLocale());
    ...
    public void testFormat_zoneText() {
        DateTime dt = new DateTime(2004, 6, 9, 10, 20, 30, 40, UTC);
        DateTimeFormatter f = DateTimeFormat.forPattern("z").withLocale(LocaleInfo.getCurrentLocale());
    ...
    public void testFormat_zoneLongText() {
        DateTime dt = new DateTime(2004, 6, 9, 10, 20, 30, 40, UTC);
        DateTimeFormatter f = DateTimeFormat.forPattern("zzzz").withLocale(LocaleInfo.getCurrentLocale());
    ...
    public void testFormat_zoneAmountColon() {
        DateTime dt = new DateTime(2004, 6, 9, 10, 20, 30, 40, UTC);
        DateTimeFormatter f = DateTimeFormat.forPattern("ZZ").withLocale(LocaleInfo.getCurrentLocale());
    ...
    public void testFormat_zoneAmountID() {
        DateTime dt = new DateTime(2004, 6, 9, 10, 20, 30, 40, UTC);
        DateTimeFormatter f = DateTimeFormat.forPattern("ZZZ").withLocale(LocaleInfo.getCurrentLocale());
        assertEquals(dt.toString(), "UTC", f.print(dt));
    ...
    public void testFormatParse_textMonthJanShort_UK() {
        DateTimeFormatter dateFormatter = DateTimeFormat.forPattern("dd MMM yyyy")
            .withLocale(LocaleInfo.getCurrentLocale()).withZone(DateTimeZone.UTC);
